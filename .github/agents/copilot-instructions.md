...
- HTML5 + ES5 JavaScript (no transpilation) + CSS3 + None — standard browser APIs only (Pointer Events, FileReader, Blob, URL.createObjectURL) (002-tmm-tags-size-report)
- Browser memory (in-page `var` state) + user-controlled JSON file download/upload (002-tmm-tags-size-report)
...
## Recent Changes
- 002-tmm-tags-size-report: Added HTML5 + ES5 JavaScript (no transpilation) + CSS3 + None — standard browser APIs only (Pointer Events, FileReader, Blob, URL.createObjectURL)
